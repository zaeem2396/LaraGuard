...
**Latest release:** [v0.2.3](https://github.com/zaeem2396/LaraGuard/releases/tag/v0.2.3) — `Guard::extend()` API for third-party rules and package-friendly registration.
