...
**Latest release:** [v0.2.2](https://github.com/zaeem2396/LaraGuard/releases/tag/v0.2.2) — layer-violation rule for Controller → Service → Repository → Model boundaries.
